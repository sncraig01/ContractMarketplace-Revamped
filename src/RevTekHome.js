        ...
        <div>
            ...
            <div className="RevTekHome-Header">
                ...
                <div  className="RevTekHome-Button">
                    <Button  style={{maxWidth: '200px', maxHeight: '60px', minWidth: '200px', minHeight: '60px'}} variant="contained" color="secondary"  onClick={() => this.joinClicked()}> Join Today! </Button> 
                    <br/>
                </div>
...
{/*            
            ...
            <br/>
                <div  className="RevTekHome-Button">
                 <Button style={{maxWidth: '200px', maxHeight: '80px', minWidth: '200px', minHeight: '80px'}} variant="contained" color="secondary"  onClick={() => this.joinClicked()}> 
                    Join Today! 
                 </Button> 
                </div>
                <br/>
